...
var StatusBar = styled('div')(_templateObject5);
var VideoPlayer = styled('video')(_templateObject6);
var Button = styled('button')(_templateObject7, green, green, green, gray, green);
      ...
      return React.createElement("div", {
        ...
        render: function render(_ref) {
          var start = _ref.start,
              ...
              pause = _ref.pause,
              resume = _ref.resume;
          return React.createElement("div", null, !_this2.isReadOnly() ? React.createElement(StatusBar, null, React.createElement(EditorControls, null, React.createElement(Button, {
          ...
          }, "REC"), _this2.state.recording ? React.createElement(Button, {
            onClick: function onClick(e) {
              e.preventDefault();
              stop();
            },
            ref: "stopBtn",
            className: "right"
          }, "STOP REC") : null, _this2.state.fileReady ? React.createElement(Button, {
            className: "right",
            onClick: function onClick(e) {
              e.preventDefault();
          ...
          }, "Save") : null, _this2.state.recording ? React.createElement(RecordActivity, {
            granted: granted,
            active: recording
          }) : null)) : null, React.createElement(VideoBody, null, React.createElement(VideoPlayer, {
            autoPlay: true,
            muted: true
          }), React.createElement("figcaption", {
            className: "imageCaption",
            onMouseDown: _this2.handleFocus
          }, _this2.props.block.getText().length === 0 ? React.createElement("span", {
            className: "danteDefaultPlaceholder"
          }, _this2.placeholderText()) : undefined, React.createElement(EditorBlock, Object.assign({}, _this2.props, {
            "editable": true,
            "className": "imageCaption"
          })))));
        }
...
function (_React$Component2) {
  ...
  function Loader() {
    ...
    _defineProperty(_assertThisInitialized(_this3), "render", function () {
      return React.createElement("div", null, _this3.props.toggle ? React.createElement("div", {
        className: "image-upoader-loader"
      }, React.createElement("p", null, _this3.props.progress === 100 ? "processing image..." : React.createElement("span", null, React.createElement("span", null, "loading"), Math.round(_this3.props.progress)))) : undefined);
    });
